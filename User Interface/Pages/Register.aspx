<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMaster.master" AutoEventWireup="true" CodeFile="Register.aspx.cs" Inherits="Pages_Register" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="wrapper row3">
     <div class="content"> 
     <div id="comments">
    <asp:CreateUserWizard runat="server" ID="RegisterUser" OnCreatedUser="RegisterUser_CreatedUser" OnSendingMail="RegisterUser_SendingMail">
        <WizardSteps>
...
<asp:CompleteWizardStep ID="CompleteWizardStep1" runat="server" OnLoad="Unnamed_Load">
                    <ContentTemplate>
                        <table>
                            <tr>
