<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/UserMaster.master" AutoEventWireup="true" CodeFile="CompletedCourses.aspx.cs" Inherits="Users_ActiveCourses" %>
       ...
       <ItemTemplate>
            ...
            <time datetime="2045-04-06T08">Close :<asp:Label ID="lbl_Close" runat="server" Text='<%# Eval("CourseClose") %>'></asp:Label> </time></u>
              ...
              <div class="comcont">
                  ...
                  <div>
              <asp:Button ID="btn_Enroll" runat="server" Text="Details" CommandName="Save"  PostBackUrl='<%# "~/Profiles/CourseWeek.aspx?Course="+Eval("CourseId") %>' />
                      </div>
            </article> </li> </ul>
       </ItemTemplate>
                 </asp:Repeater> 
